            ...
            <div className="grid grid-cols-3 gap-2">
              {[
                ...
                <button
                  ...
                  className="px-2 py-2 rounded-full bg-secondary text-secondary-foreground text-xs font-medium active:bg-primary active:text-primary-foreground active:scale-95 transition-all border border-border flex items-center justify-center gap-1 min-w-0"
                >
